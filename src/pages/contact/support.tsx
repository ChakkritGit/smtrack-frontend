...
function Support() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    e.preventDefault()
    if (details !== '' && email !== '' && firstName !== '' && hospitalName !== '' && lastName !== '' && codePhone !== '' && phone !== '' && wardName !== '') {
            ...
            <Row>
              <Col lg={6}>
                <LabelContact htmlFor="first-name">
                  <InputSupport type="text" id="first-name" name="first-name" placeholder={t('contactFirstName')} value={firstName} onChange={(e) => setSupportData({ ...supportData, firstName: e.target.value })} />
                </LabelContact>
              </Col>
              <Col lg={6}>
                <LabelContact htmlFor="last-name">
                  <InputSupport type="text" id="last-name" name="last-name" placeholder={t('contactLastName')} value={lastName} onChange={(e) => setSupportData({ ...supportData, lastName: e.target.value })} />
                </LabelContact>
              </Col>
              <Col lg={12}>
                <LabelContact htmlFor="email">
                  <InputSupport type="email" id="email" name="email" placeholder={t('contactEmail')} value={email} onChange={(e) => setSupportData({ ...supportData, email: e.target.value })} />
                </LabelContact>
              </Col>
              <Col lg={12}>
                <LabelContact htmlFor="tel">
                  <PhoneGroup>
                    <select name="countryCode" id="countryCode" value={codePhone} onChange={(e) => setSupportData({ ...supportData, codePhone: e.target.value })}>
                    ...
                    <InputSupport type="tel" id="email" name="tel" placeholder={t('contactPhone')} value={phone} onChange={(e) => setSupportData({ ...supportData, phone: e.target.value })} />
                  </PhoneGroup>
                </LabelContact>
              </Col>
              <Col lg={6}>
                <LabelContact htmlFor="first-name">
                  <InputSupport type="text" id="first-name" name="first-name" placeholder={t('hosName')} value={hospitalName} onChange={(e) => setSupportData({ ...supportData, hospitalName: e.target.value })} />
                </LabelContact>
              </Col>
              <Col lg={6}>
                <LabelContact htmlFor="first-name">
                  <InputSupport type="text" id="first-name" name="first-name" placeholder={t('wardName')} value={wardName} onChange={(e) => setSupportData({ ...supportData, wardName: e.target.value })} />
                </LabelContact>
              </Col>
              <Col lg={12}>
                <LabelContact htmlFor="howcanwehelp">
                  <TextAreContact
                    ...
                    rows={4}
                    value={details} onChange={(e) => setSupportData({ ...supportData, details: e.target.value })}
                  />
                </LabelContact>
              </Col>
              <Col lg={12}>
